...
Original file is located at
    https://colab.research.google.com/drive/1KOttElAvIlEA3sf6Z3sNcjleYvY3vlXt
"""
...
def three_layer_convnet(x, params):
    ...
    h1 = torch.nn.functional.conv2d(x, conv_w1, conv_b1, padding=2)
    h1 = torch.nn.functional.relu(h1)
    h2 = torch.nn.functional.conv2d(h1, conv_w2, conv_b2, padding=1)
...
class ThreeLayerConvNet(nn.Module):
    ...
    def forward(self, x):
        ...
        h1 = F.relu(self.conv_1(x))
        h2 = F.relu(self.conv_2(h1))
        h2 = flatten(h2)
        scores = self.fc(h2)
...
- used inception module (GoogLeNet)
- batch norm
