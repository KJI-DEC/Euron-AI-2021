...
$\color{blue}{\textit Your Answer:}$ SVM 알고리즘은 0에서 미분할 수 없는 max항을 가지기 때문에 비교항이 0이면 deriative가 존재하지 않는다.
...
$\color{blue}{\textit Your Answer:}$ weight이 matching에 사용되는 template image를 만들어낸다.
