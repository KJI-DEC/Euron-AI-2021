...
Original file is located at
    https://colab.research.google.com/drive/17W-bMRnmg9MulufS_evUHgVm4tuDPYEh
"""
...
param space of character-level models is smaller than that of word-level models to match features extracted from pictures
